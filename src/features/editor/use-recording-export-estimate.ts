  ...
  const signature =
    ...
    hasExportableContent
      ? [
          ...
          enabledSignature,
          cameraOverlay.cameraX,
          cameraOverlay.cameraY,
          cameraOverlay.cameraWidth,
          cameraOverlay.frameHeight,
          cameraOverlay.frameWidth,
          cameraOverlay.frameX,
          cameraOverlay.frameY,
