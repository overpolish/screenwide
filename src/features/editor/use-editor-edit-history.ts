...
type EditorEditGesture = {
  beginGesture: () => void;
  endGesture: () => void;
};

export const EditorEditGestureContext = createContext<EditorEditGesture>({
  beginGesture: () => undefined,
  endGesture: () => undefined,
});

export const useEditorEditGesture = () => use(EditorEditGestureContext);
...
export function useEditorEditHistory<State extends object>({
  apply,
  resetKey,
  state,
}: {
