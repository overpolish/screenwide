...
//! Audio prepared only for the editor window.
//!
...
#[cfg(any(target_os = "macos", target_os = "windows"))]
pub(in crate::editor) use encode::{remux_temp_path, run_export};
pub use estimate::{estimate_compressed_video_bytes, supports_compression};
#[cfg(target_os = "macos")]
pub(in crate::editor) use macos::recording_info;
pub use output::duration_ms;
pub use tools::inspect_audio_tracks;
#[cfg(target_os = "windows")]
pub(in crate::editor) use windows::recording_info;
...
pub(in crate::editor) struct RecordingInfo {
  pub duration_ms: u64,
