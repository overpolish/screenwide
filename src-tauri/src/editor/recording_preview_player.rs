...
//! Native, bounded playback for the editor window.
//!
...
pub(crate) mod annotation_preview;
mod audio;
...
use super::{
  ...
  AudioTrackVolume, CameraOverlaySettings, EditorArtifact, EditorKind, EditorState,
