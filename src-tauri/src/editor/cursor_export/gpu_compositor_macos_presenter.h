...
// The retained-workspace presenter behind the native editor panes: the layer
// scene it keeps, the gestures that transform that scene in place, and the
// presents that draw it.
