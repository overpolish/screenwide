...
// Preserve upstream support for the legacy multi-file pasteboard representation.
#[allow(deprecated)]
...
#[allow(deprecated)] // Legacy file-list interoperability; keep the upstream drag/drop behavior.
